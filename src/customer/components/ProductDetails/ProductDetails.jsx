      ...
      <div className="pt-6">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60 text-sm">1020201 Ratings</p>
                  <p className="text-sm ml-5 font-medium text-indigo-500 hover:text-indigo-300">
                    121121 Reviews
                  </p>
                </div>
              </div>
        ...
        <section className="flex flex-col justify-center">
          ...
          <div className="border p-5">
            <Grid container spacing={7} className="justify-center">
              <Grid item sx={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3 justify-center">
                  ...
                  <p className="placeholder-opacity-60">54981 rattings</p>
                </div>
        ...
        <section className="pt-10">
          <h1 className="text-xl py-5 font-bold">Simillar Products</h1>
